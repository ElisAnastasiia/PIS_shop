...
public class UserDao implements IDao<User> {
    ...
    final static private String INSERT = "insert into user (username, password, balance) values(?, ?, ?)";
    final static private String DELETE = "delete from user where id = ?";
    final static private String UPDATE = "update user set username = ?, password = ?, balance = ? where id = ?";
    @Override
